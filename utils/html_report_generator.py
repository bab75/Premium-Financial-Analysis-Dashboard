...
class HTMLReportGenerator:
    def generate_comprehensive_report(
        ...
        # Add all visualizations from additional_figures
        chart_mappings = [
        ...
        try:
            ...
            html_content += "<h3>Risk Metrics</h3>"
            html_content += f"""
            <div class="metric-card">
            ...
            try:
                ...
                if summary:
                    ...
                    <div class="metric-card">
                        ...
                        <div class="metric"><strong>Avg Change</strong><br>{summary.get('avg_change', 0):.2f}%</div>
                ...
                if not sector_analysis.empty:
                    html_content += "<h3>Sector Performance</h3>"
        ...
        """
        if not historical_data.empty:
            summary_stats = historical_data['Close'].describe()
            html_content += "<h3>Price Statistics</h3><table>"
...
# End of html_report_generator.py
