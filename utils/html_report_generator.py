...
class HTMLReportGenerator:
    ...
    def generate_comprehensive_report(self, 
        ...
        html_content = [
            ...
            '<html>',
            '<head>',
            '    <title>Financial Analysis Report - %s</title>' % stock_symbol,
            '    <meta charset="UTF-8">',
            ...
            '                        Financial Analysis Report: %s' % stock_symbol,
            '                    </h1>',
            '                    <p className="text-center text-gray-600 mb-8">Generated on: %s</p>' % timestamp,
            '                    ',
        ...
        html_content.extend([
            ...
            '                        <p>Data analysis period: %s to %s</p>' % (start_date, end_date),
            '                    </div>',
            '                </div>',
            '            );',
            '        }',
