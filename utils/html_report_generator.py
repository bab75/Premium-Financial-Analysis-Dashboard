...
tly.subplots import make_subplots
...
MLReportGenerator:
enerate comprehensive HTML reports with interactive charts and analysis."""
        ...
        if confidence_data:
            ...
            html_section += f"""
                ...
                Prediction Metrics & Reliability
                    	...
                    	Metric	Value
nce Level	{confidence_display}
trength	{confidence_data.get('trend_strength', 'N/A')}
ality	{confidence_data.get('data_quality', 'N/A')}
ity Risk	{volatility_display}
